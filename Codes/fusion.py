...
x_features_s1 = np.load("x_features_s1.npy")
# x_features_s2 = np.load("x_features_s2.npy")

x_features_s2 = x_features_cnn


x_shk = np.concatenate((x_features_s1,x_features_s2),axis=1)

# x_shk =x_features_cnn

# np.save("x_features_s2.npy",x_features_cnn)
...
pca = PCA()
pca.fit(x_shk,data_labels_encoded)
x_value= pca.fit_transform(x_shk)
